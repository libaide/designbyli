...
<section className="relative overflow-hidden py-20">
  ...
  <Container>
    <RevealOnScroll className="relative z-10" threshold={0.25}>
      {({ inView }) => (
...
<section className="relative overflow-hidden bg-white">
  <div className="relative mx-auto w-full max-w-6xl px-4 py-20 lg:py-20">
    ...
    {(() => {
      ...
      return (
        <div
          ref={ref}
          className={[
            "relative z-10 max-w-xl lg:max-w-[560px] lg:rounded-3xl lg:bg-[#FFD000] lg:p-10 lg:shadow-sm",
            // animation
            "transition-all duration-700 ease-out will-change-transform will-change-opacity",
    ...
    {/* Desktop image: bigger + allow it to bleed outside container */}
          ...
          <div className="mt-16 grid gap-10 lg:grid-cols-2 lg:gap-12">
            ...
            <div className="rounded-3xl border border-black/5 bg-white p-10 shadow-[0_25px_70px_rgba(15,23,42,0.18)] sm:p-12">
              <div className="flex items-center gap-4">
                ...
                <h4 className="text-2xl font-semibold tracking-tight text-[#1B2166]">Success Metrics</h4>
              </div>
