...
export default function OperatorCaseStudy() {
  ...
  return (
    <>
      {/* TOP BLOCK — Split + core apps + overview cards (single section) */}
  ...
  <span className="font-base">(now Crescendo)</span>, internal platform that unified multiple
  support operations tools into one product suite. It helps agents,
  managers, and admins work faster with consistent workflows, shared
  data, and a cohesive UI across applications.
</p>
      ...
      {/* Problem & Context — MUST be inside the fragment */}
...
<div className="mt-16">
  ...
  {/* images BELOW — 4 columns on desktop */}
  <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
    ...
    <div className="rounded-2xl border border-black/10 bg-white p-6 shadow-[0_18px_50px_rgba(15,23,42,0.10)]">
      <h4 className="font-normal text-2xl text-[#474747]">Agent experience</h4>
...
<section className="relative overflow-hidden py-20">
  ...
  <Container>
    <div className="relative z-10">
      ...
      {/* Lightbox (same pattern as Domus) — keep at the end */}
      {expandedImage ? (
        <div
