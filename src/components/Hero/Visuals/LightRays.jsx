...
const LightRays = ({
  ...
  // IMPORTANT: paused as a ref so it doesn't force re-init
...
void main() {
  ...
  gl_FragColor  = color;
    ...
    const loop = (t) => {
      ...
      // If paused, keep the canvas mounted but skip rendering (no teardown = no flicker)
    ...
    return () => {
      ...
      // NOTE: no WEBGL_lose_context on scroll-driven behavior; only on unmount
      try {
